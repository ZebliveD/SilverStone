...
echo.
echo.
echo           UPDATING PLEASE WAIT ...  [UPDATE.BAT]   
echo                 [ SilverStone 1.8 ]
echo.
echo               --\  EXIT After Update  \--
echo.
git clone https://github.com/ZebliveD/SilverStone
echo.
echo. 
echo             ...  UPDATE COMPLETE PLEASE EXIT ...  
echo.
echo.
...
:OUI
start Metasploit-Framework-Discord.bat
echo.
echo Loading sfMenu
echo.
pause
